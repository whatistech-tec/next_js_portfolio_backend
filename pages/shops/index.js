...
export default function shops() {
    ...
    const [currentPage, setCurrentPage] = useState(1);
     ...
     const [alldata, loading] = useFetchData('/shops/projects');
      ...
      <div className="blogpage">
        <div className="titledashboard flex flex-sb">
            ...
            <div className="breadcrumb">
                <SiBloglovin/><span>/</span> <span>Product</span>
            </div>
        </div>
                                ...
                                <tr key={product._id}>
                                    ...
                                    <td>
                                        <div className="flex gap-2 flex-center">
                                            <Link href={'/product/edit/' + blog._id}><button><FaEdit/></button></Link>
                                            <Link href={'/product/delete/' + blog._id}><button><RiDeleteBin6Fill/></button></Link>
                                        </div>
                                    </td>
