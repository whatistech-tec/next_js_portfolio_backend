                ...
                <tbody>
                    {loading ? <>
                        ...
                        {publishedblogs.length === 0 ? (
                            ...
                            publishedblogs.map((project, index) => (
                                <tr key={project._id}>
                                    <td>{indexOfFirstBlog + index + 1}</td>
                                    <td><img src={project.images[0]} width={180} alt="image"/></td>
                                    <td><h3>{project.title}</h3></td>
                                    <td>
                                        <div className="flex gap-2 flex-center">
                                            <Link href={'/projects/edit/' + project._id}><button><FaEdit/></button></Link>
                                            <Link href={'/projects/delete/' + project._id}><button><RiDeleteBin6Fill/></button></Link>
                                        </div>
                                    </td>
